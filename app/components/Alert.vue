...
const config = computed(() => ({
  success: {
    ...
    subtext: 'text-muted',
    icon: CircleCheck,
    actionPrimary: 'text-white bg-emerald-500 hover:bg-emerald-600 px-4 py-2 cursor-pointer rounded-xl text-xs font-semibold transition-colors',
    actionSecondary: 'text-muted hover:text-black/70 px-4 py-2 cursor-pointer rounded-xl text-xs font-semibold transition-colors hover:bg-muted/10',
  },
  danger: {
    bg: 'bg-white',
    text: 'text-red-600',
    subtext: 'text-muted',
    icon: TriangleAlert,
    actionPrimary: 'text-white bg-red-500 hover:bg-red-600 px-4 py-2 cursor-pointer rounded-xl text-xs font-semibold transition-colors',
    actionSecondary: 'text-muted hover:text-black/70 px-4 py-2 cursor-pointer rounded-xl text-xs font-semibold transition-colors hover:bg-muted/10',
  },
  info: {
    bg: 'bg-white',
    ...
    subtext: 'text-muted',
    icon: Info,
    actionPrimary: 'text-white bg-blue-500 hover:bg-blue-600 px-4 py-2 cursor-pointer rounded-xl text-xs font-semibold transition-colors',
    actionSecondary: 'text-muted hover:text-black/70 px-4 py-2 cursor-pointer rounded-xl text-xs font-semibold transition-colors hover:bg-muted/10',
  },
}[props.type]))
