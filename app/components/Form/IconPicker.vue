...
const icons = [
  ...
  { name: 'lucide:headphones', label: 'Podcast' },
  { name: 'lucide:brain', label: 'Focus' },
  { name: 'lucide:heart', label: 'Self-love' },
...
<template>
  <div class="space-y-3">
    ...
    <!-- Grid -->
    <div class="grid grid-cols-4 gap-2 max-h-72 overflow-y-auto pr-1">
